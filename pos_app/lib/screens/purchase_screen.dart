          ...
          */
          ...
          Expanded(
            child: OutlinedButton.icon(
              ...
              label: Text(
                fromDate == null ? 'From Date' : formatDateParam(fromDate!),
              ),
            ),
          ),
          ...
          */
          ...
          Expanded(
            child: OutlinedButton.icon(
              ...
              icon: const Icon(Icons.date_range),
              label: Text(
                toDate == null ? 'To Date' : formatDateParam(toDate!),
              ),
            ),
          ),
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 3),
                        Text(
                          'Manage converted supplier purchases and VAT input.',
                          style: TextStyle(
                            color: Colors.grey,
                          ),
                        ),
                    ...
                    Row(
                      children: [
                        ...
                        kpiCard(
                          ...
                          value: formatMoney(totalExclVat()),
                                  ...
                                  child: Container(
                                    ...
                                    child: const Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 6),
                                        Text(
                                          'Convert reviewed OCR receipts to purchases first.',
                                          style: TextStyle(
                                            color: Colors.grey,
                                          ),
                                        ),
